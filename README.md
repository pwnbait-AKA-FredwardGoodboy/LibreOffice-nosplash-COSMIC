...
This is a bash shell script to remove the splash screen from the LibreOffice suite for better compatibility with the COSMIC (Weyland) desktop environment in Pop!_OS 24.04.
...
**The When:**
10,000 years in the belly of the Sarlacc, this script was AI optimized with Gemini-CLI. Putting myself out of business.
